        ...
        <div class="row m-0 ">
            <div class="col-lg-4 offset-lg-2">
                <div class="text-center pb-5">
                    ...
                    <p class="p-1 m-0 font-ubuntu text-black-50">Inscris toi et profites des nouveautés</p>
                    <span class="font-ubuntu text-black-50">Je suis déjà <a href="login.php">Inscrit</a></span>
                </div>
                <div class="upload-profile-image d-flex justify-content-center pb-5">
                    <div class="text-center">
                        ...
                        <small class="form-text text-black-50">Choisir une image</small>
                ...
                <div class="d-flex justify-content-center">
                    <form action="register.php" method="post" enctype="multipart/form-data" id="reg-form">
                        ...
                        <div class="form-row my-4">
                            <div class="col">
                                <input type="password" required name="confirm_pwd" id="confirm_pwd" class="form-control" placeholder="Confirmer mot de passe*">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <label for="agreement" class="form-check-label font-ubuntu text-black-50">Je suis daccord avec les <a href="#">termes et conditions </a>(*) </label>
                        </div>

                        <div class="submit-btn text-center my-5">
                            <button type="submit" class="btn btn-warning rounded-pill text-dark px-5">Continuer</button>
                        </div>
